  ...
  <div class="index">
    <div class="seach">
      ...
      >
        ...
        <div style="margin: 0.2rem 0">
          ...
          <van-cell title="商城" icon="shopping-cart-o" style="font-size: 0.26rem">
            <template #right-icon>
              <van-icon name="arrow" class="arrow-icon" />
            </template>
          </van-cell>
        ...
        <div style="margin: 0.2rem 0">
          ...
          <van-cell title="在线听歌免流量" icon="bag-o" style="font-size: 0.26rem">
            <template #right-icon>
              <van-icon name="arrow" class="arrow-icon" />
            </template>
          </van-cell>
        ...
        <div style="margin: 0.2rem 0">
          ...
          <van-cell title="分享网易云音乐" icon="replay" style="font-size: 0.26rem">
            <template #right-icon>
              <van-icon name="arrow" class="arrow-icon" />
            </template>
          </van-cell>
    ...
    >
      <div style="height: 0.9rem; line-height: 0.9rem; margin: 0 0.3rem">
        ...
        <van-button type="primary" to="rankinglist" class="more">更多 ></van-button>
      </div>
      <!--  -->
          ...
          <mt-tab-container-item id="1" style="width: 90%">
            <div
              style="
                ...
                box-shadow: #ddd 0 0 0.04rem 0.04rem;
          ...
          <mt-tab-container-item id="2" style="width: 90%">
            <div
              style="
                ...
                padding: 0.2rem 0.28rem;
                margin: 0.2rem 0 0.2rem 0.24rem;
                box-shadow: #ddd 0 0rem 0.04rem 0.04rem;
                border-radius: 0.2rem;
                float: left;
              "
            >
